        ...
        for(double j=0.1; j<=1;j=j+0.1)
        {
            ...
            switch(predictor)
            {
                case "smithPSC":
                        ...
                        spscobj.startPrediction(n_bits,actual_pred, filename,prob);
                        break;
                ...
                case "bimodalPSC":
                            ...
                            bpscobj.startPrediction(m, actual_pred, PC, filename, prob);
                            break;
                ...
                case "gsharePSC":
                            ...
                            gpscobj.startPrediction(m, n, actual_pred, PC, filename, prob);
                            break;            
                ...
                case "hybridPSC":
                            ...
                            hpscobj.startPrediction(k,m_gshare,n,m_bimodal,actual_pred,PC,filename,prob);
                            break;                                    
            }
        }
    }
